    ...
    <div className="modal-get">
      ...
      <div className="modal-get--stretch">
        ...
        <div className="modal-get--premium">
          ...
          <div className="modal-fixed">
            <ModalFixedItem activeIcon={<FontAwesomeIcon icon={faCheck} />}>Ad-free</ModalFixedItem>
            ...
            <ModalFixedItem activeIcon={<FontAwesomeIcon icon={faCheck} />}>Notepad</ModalFixedItem>
